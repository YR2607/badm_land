        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto">
              Ведущий бадминтонный клуб Кишинева с 15-летней историей успеха
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Клуб Altius был основан в 2010 году с целью развития бадминтона в Молдове. 
                  Начав с небольшого зала, мы выросли в современный спортивный комплекс 
                  с 8 профессиональными кортами.
                </p>
                <p>
                  За годы работы через наш клуб прошли сотни спортсменов, многие из которых 
                  достигли значительных успехов на национальном и международном уровне. 
                  Мы гордимся тем, что смогли создать настоящее сообщество любителей бадминтона.
                </p>
                <p>
                  Сегодня Altius - это не просто спортивный клуб, это место, где рождается 
                  страсть к спорту, формируются характеры и создаются дружеские связи на всю жизнь.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mockCoaches.map((coach, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
              >
                <div className="w-32 h-32 bg-gradient-to-br from-primary-blue to-primary-orange rounded-full flex items-center justify-center text-white text-4xl mx-auto mb-6">
                  👨‍🏫
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">{coach.name}</h3>
                <p className="text-primary-blue font-medium mb-2">{coach.title}</p>
                <p className="text-gray-600 mb-4">Опыт: {coach.experience}</p>
